...
// ImageIcon("Textures/CandyBreaking/blue.gif").getImage();
// candyAnimation[1] = new
// ImageIcon("Textures/CandyBreaking/green.gif").getImage();
// candyAnimation[2] = new
// ImageIcon("Textures/CandyBreaking/red.gif").getImage();
// candyAnimation[3] = new
// ImageIcon("Textures/CandyBreaking/orange.gif").getImage();
// candyAnimation[4] = new
// ImageIcon("Textures/CandyBreaking/purple.gif").getImage();
// candyAnimation[5] = new
// ImageIcon("Textures/CandyBreaking/yellow.gif").getImage();
...
// stripedCandiesV[CandyColors.BLUE] =
// getImageSpecialCandies("Striped_blue_v.png");
// stripedCandiesV[CandyColors.GREEN] =
// getImageSpecialCandies("Striped_green_v.png");
// stripedCandiesV[CandyColors.RED] =
// getImageSpecialCandies("Striped_red_v.png");
// stripedCandiesV[CandyColors.ORANGE] =
// getImageSpecialCandies("Striped_orange_v.png");
// stripedCandiesV[CandyColors.VIOLET] =
// getImageSpecialCandies("Striped_purple_v.png");
// stripedCandiesV[CandyColors.YELLOW] =
// getImageSpecialCandies("Striped_yellow_v.png");

// stripedCandiesH[CandyColors.BLUE] =
// getImageSpecialCandies("Striped_blue_h.png");
// stripedCandiesH[CandyColors.GREEN] =
// getImageSpecialCandies("Striped_green_h.png");
// stripedCandiesH[CandyColors.RED] =
// getImageSpecialCandies("Striped_red_h.png");
// stripedCandiesH[CandyColors.ORANGE] =
// getImageSpecialCandies("Striped_orange_h.png");
// stripedCandiesH[CandyColors.VIOLET] =
// getImageSpecialCandies("Striped_purple_h.png");
// stripedCandiesH[CandyColors.YELLOW] =
// getImageSpecialCandies("Striped_yellow_h.png");
// }
