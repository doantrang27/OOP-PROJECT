...
// public class Logic {
// private final Board_Test board;
// private final int candies_width, candies_height;
// private final Candy_Test[][] candies;
// private final Candy_Test[][] Replacement_candies;
// private final Random random = new Random();
// private int ClickCounter = 0;
// private int FirstCandyCol, FirstCandyRow, SecondCandyRow, SecondCandyCol;
// private final Candy_Test switchedCandy = new Candy_Test();
// private final Image game_background = new
// ImageIcon("Candy_Crush/res/bg-candy.jpg").getImage();
// private final Image win_gif = new
// ImageIcon("Candy_Crush/res/oie_OeMAOSwhprac.gif").getImage();
// private final Image out_of_moves_image = new ImageIcon(/* out of move imange
// */).getImage();
// private final Image next_icon_big = new
// ImageIcon("Candy_Crush/res/close_button.png").getImage();
...
// private final Image Dispenser = new
// ImageIcon("Candy_Crush/res/Dispenser.png").getImage();
// private final Image obstacleImage = new
// ImageIcon("Candy_Crush/res/ice.png").getImage();
// private List<Point> obstacles = new ArrayList<>();

// public Logic(int candies_width, int candies_height, int moves_count, int
// AmountOfCandies) {
...
// candies = new Candy_Test[candies_width][candies_height];
// Replacement_candies = new Candy_Test[candies_width][candies_height];
// board = new Board_Test(candies_height, candies_width);

// try {
// Candy_font = Font.createFont(Font.TRUETYPE_FONT, new
// File("Candy_Crush/res/CANDY.TTF")).deriveFont(30f);
// GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
// ge.registerFont(Font.createFont(Font.TRUETYPE_FONT, new
// File("Candy_Crush/res/CANDY.TTF")));
...
// for (int i = 0; i < candies_width; i++) {
// for (int j = 0; j < candies_height; j++) {
// if (j < candies_height - 2 && candies[i][j].getCandyType() == candies[i][j +
// 1].getCandyType()
...
// } else if (i < candies_width - 2 && candies[i][j].getCandyType() == candies[i
// + 1][j].getCandyType()
...
// for (int i = 0; i < candies_width; i++) {
// for (int j = 0; j < candies_height; j++) {
// g.drawImage(candies[i][j].getCandyShape(), candies[i][j].getPx(),
// candies[i][j].getPy(), null);
// g.drawImage(Replacement_candies[i][j].getCandyShape(),
// Replacement_candies[i][j].getPx(),
...
// public boolean isObstacleNextToMatches(){
// for (Point obstacle : obstacles){
// if (match_checker()){
// for (int i = 0; i < candies_width; i++) {
// for (int j = 0; j < candies_height; j++) {
...
// // LOGIC
// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// public void Switch(Candy_Test firstCandy, Candy_Test secondCandy) {
...
// for (int i = 0; i < candies_width; i++) {
// for (int j = 0; j < candies_height; j++) {
// if (j < candies_height - 1 && candies[i][j].getCandyType() == candies[i][j +
// 1].getCandyType()
...
// && candies[i + 1][j - 1].getCandyType() == candies[i][j].getCandyType())
// || (j > 1 && candies[i][j - 2].getCandyType() ==
// candies[i][j].getCandyType()))) {
// return true;
// } else if (i < candies_width - 1 && candies[i][j].getCandyType() == candies[i
// + 1][j].getCandyType()
...
// && candies[i - 1][j + 1].getCandyType() == candies[i][j].getCandyType())
// || (i > 1 && candies[i - 2][j].getCandyType() ==
// candies[i][j].getCandyType()))) {
// return true;
// } else if (j < candies_height - 2 && candies[i][j].getCandyType() ==
// candies[i][j + 2].getCandyType() &&
// ((i > 0 && candies[i - 1][j + 1].getCandyType() ==
// candies[i][j].getCandyType())
// || (i < candies_width - 1
// && candies[i + 1][j + 1].getCandyType() == candies[i][j].getCandyType()))) {
// return true;
// } else if (i < candies_width - 2 && candies[i][j].getCandyType() == candies[i
// + 2][j].getCandyType() &&
// ((j > 0 && candies[i + 1][j - 1].getCandyType() ==
// candies[i][j].getCandyType())
// || (j < candies_height - 1
// && candies[i + 1][j + 1].getCandyType() == candies[i][j].getCandyType()))) {
// return true;
...
// for (int i = 0; i < candies_width; i++) {
// for (int j = 0; j < candies_height; j++) {
// if (clicked_x >= candies[i][j].getPx() && clicked_x <= candies[i][j].getPx()
// + 50
// && clicked_y >= candies[i][j].getPy() && clicked_y <= candies[i][j].getPy() +
// 50
// && ClickCounter == 0) {
// FirstCandyRow = i;
// FirstCandyCol = j;
...
// } else if (clicked_x >= candies[i][j].getPx() && clicked_x <=
// candies[i][j].getPx() + 50
// && clicked_y >= candies[i][j].getPy() && clicked_y <= candies[i][j].getPy() +
// 50) {
// ClickCounter += 1;
// SecondCandyRow = i;
...
// direction = -1;
// if (match_confirm()) {
// swap(candies[FirstCandyRow][FirstCandyCol],
// candies[SecondCandyRow][SecondCandyCol]);
// } else
// Non_Matching_swap(candies[FirstCandyRow][FirstCandyCol],
// candies[SecondCandyRow][SecondCandyCol]);
// }
// // right
// else if (SecondCandyRow - 1 == FirstCandyRow && SecondCandyCol ==
// FirstCandyCol) {
// CurrentPos = candies[SecondCandyRow][SecondCandyCol].getPx();
// isHorizontal = true;
// direction = 1;
...
// }
// // down
// else if (SecondCandyRow == FirstCandyRow && SecondCandyCol - 1 ==
// FirstCandyCol) {
// isHorizontal = false;
// direction = 1;
...
// public void swap(Candy_Test c1, Candy_Test c2) {
// Moves_count--;
// swapping = true;
// if (isHorizontal) {
...
// public void Non_Matching_swap(Candy_Test candy1, Candy_Test candy2) {
...
// Switch(candies[FirstCandyRow][FirstCandyCol],
// candies[SecondCandyRow][SecondCandyCol]);
// if (match_checker()) {
// return true;
// }
...
// candies[i][j].getCandyType() == candies[i][j + 2].getCandyType() &&
// !candies[i][j].isBroke() && !candies[i][j + 1].isBroke() && !candies[i][j +
// 2].isBroke()) {
...
// for (int x = j; x <= j + 2; x++) {
// if (i < candies_width - 2 && candies[i][x].getCandyType() == candies[i +
// 1][x].getCandyType()
...
// } else if (i >= 2 && candies[i][x].getCandyType() == candies[i -
// 1][x].getCandyType()
// && candies[i][x].getCandyType() == candies[i - 2][x].getCandyType()) {
// candies[i - 1][x].setBroke(true);
// candies[i - 1][x].setCandyAnimation(candies[i - 1][x].getCandyType());
...
// // sọc
// if (j < candies_height - 3 && candies[i][j + 3].getCandyType() ==
// candies[i][j].getCandyType()) {
...
// candies[i][j].getCandyType() == candies[i + 2][j].getCandyType() &&
// !candies[i][j].isBroke() && !candies[i + 1][j].isBroke() && !candies[i +
// 2][j].isBroke()) {
// // 3 candies
// candies[i][j].setBroke(true);
...
// // explode
// for (int x = i; x <= i + 2; x++) {
// if (j < candies_height - 2 && candies[x][j].getCandyType() == candies[x][j +
// 1].getCandyType()
...
// System.out.println("i am in");
// } else if (j >= 2 && candies[x][j].getCandyType() == candies[x][j -
// 1].getCandyType()
// && candies[x][j].getCandyType() == candies[x][j - 2].getCandyType()) {
// candies[x][j - 1].setBroke(true);
// candies[x][j - 1].setCandyAnimation(candies[x][j - 1].getCandyType());
...
// // stripe
// if (i < candies_width - 3 && candies[i + 3][j].getCandyType() ==
// candies[i][j].getCandyType()) {
...
// List<Point> removedObstacles = new ArrayList<>();
// for (Point obstacle : obstacles) {
// if (Math.abs(obstacle.x - i) <= 1 && Math.abs(obstacle.y - j) <= 1) {
// removedObstacles.add(obstacle);
// }
// }
// obstacles.removeAll(removedObstacles);
// }
...
// .setPy(Replacement_candies[i][j].getPy() +
// Replacement_candies[i][j].getVelY());
// }
// }
